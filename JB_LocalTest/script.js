...
extractColorVideo.addEventListener('click', (event) => { 
  ...
  alert("Color:" + "%c  ", consoleColorPaletteCSS);
  // console.log now displays actual color palette instead of RGB values
...
thuElement.addEventListener('change',(event)=>{
    console.log("asdf");
    if(event.target.value=='NoCurl') thu[0] = 0;
    else if(event.target.value=='HalfCurl') thu[0] = 1;
    else thu[0] = 2;
    console.log(thu);
})
...
thuDirElement.addEventListener('change',(event)=>{
    if(event.target.value=='1') thu[2] = 0;
    else if(event.target.value=='2') thu[2] = 4;
    else if(event.target.value=='3') thu[2] = 3;
    else if(event.target.value=='4') thu[2] = 6;
    else if(event.target.value=='5') thu[2] = 1;
    else if(event.target.value=='6') thu[2] = 7;
    else if(event.target.value=='7') thu[2] = 2;
    else if(event.target.value=='8') thu[2] = 5;
})
...
indElement.addEventListener('change',(event)=>{
    if(event.target.value=='NoCurl') ind[0] = 0;
    else if(event.target.value=='HalfCurl') ind[0] = 1;
    else ind[0] = 2;
})
...
indDirElement.addEventListener('change',(event)=>{
    if(event.target.value=='1') ind[2] = 0;
    else if(event.target.value=='2') ind[2] = 4;
    else if(event.target.value=='3') ind[2] = 3;
    else if(event.target.value=='4') ind[2] = 6;
    else if(event.target.value=='5') ind[2] = 1;
    else if(event.target.value=='6') ind[2] = 7;
    else if(event.target.value=='7') ind[2] = 2;
    else if(event.target.value=='8') ind[2] = 5;
})
...
midElement.addEventListener('change',(event)=>{
    if(event.target.value=='NoCurl') mid[0] = 0;
    else if(event.target.value=='HalfCurl') mid[0] = 1;
    else mid[0] = 2;
})
...
midDirElement.addEventListener('change',(event)=>{
    if(event.target.value=='1') mid[2] = 0;
    else if(event.target.value=='2') mid[2] = 4;
    else if(event.target.value=='3') mid[2] = 3;
    else if(event.target.value=='4') mid[2] = 6;
    else if(event.target.value=='5') mid[2] = 1;
    else if(event.target.value=='6') mid[2] = 7;
    else if(event.target.value=='7') mid[2] = 2;
    else if(event.target.value=='8') mid[2] = 5;
})
...
rinElement.addEventListener('change',(event)=>{
    if(event.target.value=='NoCurl') rin[0] = 0;
    else if(event.target.value=='HalfCurl') rin[0] = 1;
    else rin[0] = 2;
})
...
rinDirElement.addEventListener('change',(event)=>{
    if(event.target.value=='1') rin[2] = 0;
    else if(event.target.value=='2') rin[2] = 4;
    else if(event.target.value=='3') rin[2] = 3;
    else if(event.target.value=='4') rin[2] = 6;
    else if(event.target.value=='5') rin[2] = 1;
    else if(event.target.value=='6') rin[2] = 7;
    else if(event.target.value=='7') rin[2] = 2;
    else if(event.target.value=='8') rin[2] = 5;
})
...
pinElement.addEventListener('change',(event)=>{
    if(event.target.value=='NoCurl') pin[0] = 0;
    else if(event.target.value=='HalfCurl') pin[0] = 1;
    else pin[0] = 2;
})
...
pinDirElement.addEventListener('change',(event)=>{
    if(event.target.value=='1') pin[2] = 0;
    else if(event.target.value=='2') pin[2] = 4;
    else if(event.target.value=='3') pin[2] = 3;
    else if(event.target.value=='4') pin[2] = 6;
    else if(event.target.value=='5') pin[2] = 1;
    else if(event.target.value=='6') pin[2] = 7;
    else if(event.target.value=='7') pin[2] = 2;
    else if(event.target.value=='8') pin[2] = 5;
})
